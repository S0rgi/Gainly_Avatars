...
func (c *userServiceClient) ValidateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (UnimplementedUserServiceServer) ValidateToken(context.Context, *TokenRequest) (*UserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidateToken not implemented")
}
func (UnimplementedUserServiceServer) CheckFriendship(context.Context, *FriendshipRequest) (*FriendshipResponse, error) {
